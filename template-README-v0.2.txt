...
This file: should be template-README-v0.2.txt (or similar)
...
pandoc -f gfm -t html <filename>.md -c styles/markdown-styles-v1.7.css --toc --toc-depth=5 -s -o <filename>.html --metadata title="Title of Specification Version 1.0"
...
- All the "front matter" lists (TOC, file names, Editors, etc.) are generated with bullets, most of which need to be suppressed in OASIS style.
